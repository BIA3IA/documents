...
\begin{center}
    {\Huge\color{pn-text}\headlinefont\textbf{PoliNetwork}}\\[0.5em]
    {\Large\color{pn-text-secondary}Di studenti, per studenti.}\\[1.5em]
    {\large\color{pn-primary}\textbf{Associazione di Promozione Sociale}}\\[0.3em]
    {\normalsize\color{pn-text-secondary}Ente del Terzo Settore $\cdot$ Indipendente dal Politecnico di Milano}\\[1em]
\end{center}
\pnRule
\vspace{1em}
