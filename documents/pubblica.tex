% ============================================================
% DOCUMENTO 1: VERSIONE PUBBLICA
% "Cos'è PoliNetwork" — Per candidati e pubblico esterno
% Da inserire nel linktree / link in bio / sito web
% ============================================================
...
% --- Colori ---
\definecolor{pnblue}{HTML}{1A73E8}
\definecolor{pngray}{HTML}{5F6368}
\definecolor{pnlight}{HTML}{E8F0FE}

% --- Header/Footer ---
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textcolor{pngray}{\small PoliNetwork APS}}
\fancyhead[R]{\textcolor{pngray}{\small Versione pubblica}}
\fancyfoot[C]{\textcolor{pngray}{\small \thepage}}
\renewcommand{\headrulewidth}{0.4pt}

% --- Titoli ---
\titleformat{\section}
  {\Large\bfseries\color{pnblue}}{\thesection}{1em}{}
\titleformat{\subsection}
  {\large\bfseries\color{pnblue!80!black}}{\thesubsection}{1em}{}
...
% === TITOLO ===
\begin{center}
    {\Huge\bfseries\textcolor{pnblue}{PoliNetwork}}\\[0.5em]
    {\Large\textcolor{pngray}{Di studenti, per studenti.}}\\[1.5em]
    {\large Associazione di Promozione Sociale}\\[0.3em]
    {\normalsize Ente del Terzo Settore $\cdot$ Indipendente dal Politecnico di Milano}\\[2em]
...
\begin{tabularx}{\textwidth}{>{\bfseries\color{pnblue}}l X}
\toprule
...
\begin{center}
    ...
    \textcolor{pngray}{\small PoliNetwork APS — Ente del Terzo Settore}\\
    \textcolor{pngray}{\small Sede legale: Milano}\\
    \textcolor{pngray}{\small Tutti i progetti software sono rilasciati con licenza open source}
\end{center}
